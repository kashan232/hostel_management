                            ...
                            <div class="dropdown-menu dropdown-menu-end pb-0" style="">
                                <div class="card mb-0">
                                    ...
                                    <div class="card-body p-3">
                                        <a href="{{ route('guest-Change-Password') }}" class="dropdown-item ai-icon ">
                                    ...
                                    <form method="POST" action="{{ route('logout') }}">
                                        @csrf
                                        <a href="route('logout')" onclick="event.preventDefault(); this.closest('form').submit();" class="dropdown-item ai-icon btn btn-primary light">
                                            ...
                                            <span class="ms-2 text-primary">{{ __('Log Out') }}  </span>
                                        </a>
